            ...
            <div class="col-lg-4">
                <div class="widget">
                    ...
                    <ul class="list-unstyled float-start links">
                        ...
                        <li><a href="index.html">Misi</a></li>
                        <li><a href="CP TEMANKU LOGISTIK_compressed.pdf">Company Profile</a></li>
                        <li><a href="cekresi.html">Cek Resi</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-4">
        ...
        <div class="row mt-5">
            <div class="col-12 text-center">
                <p>Copyright &copy;
                    ...
                    </script>. All Rights Reserved. &mdash; Temanku Logistik
            </div>
        </div>
    </div>
</div>
