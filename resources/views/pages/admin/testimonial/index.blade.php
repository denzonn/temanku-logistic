...
@section('content')
    <div class="flex flex-row justify-between items-center mb-4">
        <div class="">
            ...
            <div class=" font-semibold text-primary text-4xl">Testimonial</div>
        </div>
        <div class="w-full flex flex-row justify-end">
            <a href="{{ route('testimonial.create') }}" class="py-2 px-6 rounded-md bg-primary text-white">Add Testimonial</a>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function() {
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            return '<img src="{{ url('storage') }}/' + data +
                                '" alt="Testimonial Image" class="w-full object-cover">';
                        }
                    },
                    {
                        data: 'name',
                    ...
                    },
                    {
                        ...
                        render: function(data) {
                            let editUrl = '{{ route('testimonial.edit', ':id') }}';
                            let deleteUrl = '{{ route('testimonial.destroy', ':id') }}';
            ...
            $(document).on('click', '.delete-button', function(e) {
                ...
                Swal.fire({
                    title: 'Are you sure?',
                    text: "Apakah kamu ingin menghapus Testimonial?",
                    icon: 'warning',
