        ...
        <div class="container">
            <div class="row align-items-center justify-content-center pt-5">
                <div class="col-lg-6 text-center pe-lg-5">
                    <h1 class="heading text-white mb-3" data-aos="fade-up">Pelayanan Kami</h1>
                    <p class="text-white mb-4" data-aos="fade-up" data-aos-delay="100">Pelayanan terbaik menjadi suatu
                        keutamaan kami.</p>
                    <div class="align-items-center mb-4" data-aos="fade-up" data-aos-delay="200">
                        <a href="https://wa.me/message/VCWHU6KIILNPF1" class="btn btn-outline-white-reverse me-4">Contact
                            us</a>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-lg-7 mb-4 mb-lg-0" data-aos="fade-up">
                    <img src="images/gambar10.jpg" alt="Image" class="img-fluid rounded
                ">
                </div>
                <div class="col-lg-4 ps-lg-2" data-aos="fade-up" data-aos-delay="100">
                    <div class="mb-5">
                        <h2 class="text-black h4">Pelayanan</h2>
                        <p></p>
                    </div>
                    <div class="d-flex mb-3 service-alt">
                        ...
                        <div>
                            ...
                            <p>Penjemputan dan Pengantaran barang dan kendaraan sampai tujuan </p>
                        </div>
                    </div>
                    ...
                    <div class="d-flex mb-3 service-alt">
                        ...
                        <div>
                            <h3>Free PickUp</h3>
                            <p>Gratis biaya penjemputan barang dan kendaraan wilayah Makassar dan Jakarta</p>
                        </div>
                    </div>
                    <div class="d-flex mb-3 service-alt">
                        <div>
                        ...
                        <div>
                            <h3>Via Laut, Darat dan Udara</h3>
                            <p>Melayani pengiriman Via Laut, Darat dan Udara.</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-lg-5 text-end" data-aos="fade-up" data-aos-delay="100">
                    <a href="https://wa.me/message/VCWHU6KIILNPF1" class="btn btn-outline-white-reverse">Contact us</a>
                </div>
            </div>
        </div>
    </div>
